...
public class CardIOCordovaPlugin extends CordovaPlugin {
    ...
    private void scan(JSONArray args) throws JSONException {
        ...
        scanIntent.putExtra(CardIOActivity.EXTRA_SUPPRESS_MANUAL_ENTRY, this.getConfiguration(configurations, "suppressManual", true)); // default: false
        ...
        scanIntent.putExtra(CardIOActivity.EXTRA_SUPPRESS_CONFIRMATION, this.getConfiguration(configurations, "suppressConfirmation", true)); // default: false
        scanIntent.putExtra(CardIOActivity.EXTRA_HIDE_CARDIO_LOGO, this.getConfiguration(configurations, "hideCardIOLogo", true)); // default: false
        scanIntent.putExtra(CardIOActivity.EXTRA_SUPPRESS_SCAN, this.getConfiguration(configurations, "suppressScan", true)); // default: false
        scanIntent.putExtra(CardIOActivity.EXTRA_RETURN_CARD_IMAGE, this.getConfiguration(configurations, "returnCardImage", true)); // default: false
        scanIntent.putExtra(CardIOActivity.EXTRA_CAPTURED_CARD_IMAGE, this.getConfiguration(configurations, "capturedCardImage", true)); // default: false
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if (resultCode != Activity.RESULT_CANCELED) {
            this.callbackContext.success(intent.getExtras().getByteArray(CardIOActivity.EXTRA_CAPTURED_CARD_IMAGE));
